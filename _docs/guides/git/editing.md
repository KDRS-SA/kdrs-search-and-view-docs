...
<br><br>
![](../../../assets/images/guides/git/editing/open-template.png)

2. Open the `Source Control` view in the activity bar:
<br><br>
![](../../../assets/images/guides/git/editing/source-control.png)
...
<br><br>
![](../../../assets/images/guides/git/editing/selected-version.png)
<br>
...
<br><br>
![](../../../assets/images/guides/git/editing/branch-select.png)
<br>
...
<br>
![](../../../assets/images/guides/git/editing/synchronize.png)

5. Click the "checkout button" again, but now pick "Create new branch"
<br>
![](../../../assets/images/guides/git/editing/create-branch.png)
<br>
Give the branch a name and press `Enter`:
<br>
![](../../../assets/images/guides/git/editing/name-branch.png)
<br>
...
<br>
![](../../../assets/images/guides/git/editing/stage-all-changes.png)

8. Type a message describing the changes you made, and click "Commit"
<br>
![](../../../assets/images/guides/git/editing/commit.png)
...
<br>
![](../../../assets/images/guides/git/editing/publish-branch.png)
<br>
...
<br>
![](../../../assets/images/guides/git/editing/update-all.png)
...
![](../../../assets/images/guides/git/editing/sv-checkout.png)
<br>
