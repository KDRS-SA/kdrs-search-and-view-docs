...
![]({{ site.baseurl }}/assets/images/guides/git/clone/cloning-1.png)

In VS Code, click View -> Terminal

![]({{ site.baseurl }}/assets/images/guides/git/clone/cloning-2.png)
